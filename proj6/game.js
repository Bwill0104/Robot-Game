...
class Controller
{
	...
	onLeftClick(event) {
		...
		let player = {"id":id.toString(), "mouseX": x.toString(), "mouseY": y.toString(), "avatarX": this.model.avatar.x.toString(), "avatarY":  this.model.avatar.y.toString(), "time": now, "fid": "0", "action": "move", "name": nombre, "points": this.model.avatar.points}
